...
SYSTEM_PROMPT = """You are an expert curriculum designer and AI teaching strategist. Your task is to design a high-level lesson plan for an AI Teacher avatar to execute. 
...
def generate_lesson_plan(topic: str, learner_level: str, time_available_minutes: int) -> LessonPlan:
